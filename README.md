...
Данная работа основана на задаче, которой я и мои коллеги занимались во время стажировоки (учебной практики) в компании [Моторика](https://motorica.org/).
...
Перед началом стажировки было предложено опробовать себя в решении [тестового задания на Kaggle](https://www.kaggle.com/competitions/motorica-skillfactory-internship-test-task-2023-12).
